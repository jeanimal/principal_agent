...
tabPanel("Incomplete Info",
         fluidPage(
           ...
           helpText("Graphs: The principal's average utility (across types of ",
                    ...
                    "a 3D plot.  ",
                    "Instead, q1 is on the x-axis and q2 is on the white axis.  ",
                    "Contour lines show the level of the principal's net utility. ",
                    "The principal must pay extra to keep the efficient agent ",
                    "(agent 1 with defaults) choosing the high effort contract."),
           sidebarLayout(
             sidebarPanel(
               numericInput("ialpha",
                            "Principal's alpha (in utility):",
             ...
             mainPanel(
               ...
               helpText("The optimal contracts are shown below.  Agents can ",
                        ...
                        "with the low effort contract.  These quantities should ",
                        "locate the label 'max' in the contour plot."),
